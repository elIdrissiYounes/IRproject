...
class XmlMain {
    ...
    public static void main(String args[]) throws Exception {
    	 File dir = new File("/home/younes/workspaceEE/riProject-master/input/coll");
    	  File[] directoryListing = dir.listFiles();
           ...
           int j=0;
        for(j=0;j<6;j++){
       	 String string="/home/younes/workspaceEE/SimpleTextSearch-master/IbrahimAlexisKevinYouness_"+"02_"+j+"_ltc_"+"articles"+".txt";
            ...
            while (it.hasNext()) {
               ...
               sw.start();
    			...
    			for (SearchResult result : batch.getSearchResults()) {
    				...
    				String linee = arr[0]+ "" + " Q0 "+result.getUniqueIdentifier() +" "+ rank + " " + result.getLtc() + " "
